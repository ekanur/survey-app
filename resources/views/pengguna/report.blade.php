		...
		<div class="card card-small mb-4">
			...
			<div class="card-body p-0 pb-3">
				<div class="row">
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Penilaian untuk integritas (etika dan moral) lulusan UM dalam bekerja</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Profesionalisme lulusan UM dalam bekerja</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Penilaian Kemahiran Berkomunikasi dalam Bahasa Inggris</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Tingkat Penguasaan TIK yang Menunjang Pekerjaan</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Kemahiran dan Kecerdasan Berkomunikasi</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Kemampuan Bekerja dalam Tim</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Potensi Pengembangan Diri dalam Bekerja</span>
						</div>
		...
		<div class="card card-small mb-4">
			...
			<div class="card-body p-0 pb-3">
				<div class="row">
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Kejelasan dan Kelengkapan Informasi Persyaratan untuk Memperoleh Layanan Akademik dan non Akademik</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Prosedur Pemberian Layanan Akademik dan non Akademik</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Waktu Pemberian Layanan Akademik dan non Akademik </span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Biaya Pemberian Layanan Akademik dan non Akademik</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Produk Layanan Akademik dan non Akademik</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Kompetensi Pelaksana Layanan Akademik dan non Akademik</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Perilaku Pelaksana Layanan Akademik dan non Akademik</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Penanganan Pengaduan Layanan Akademik dan non Akademik</span>
						</div>
					...
					<div class="col-md-6">
						<div class="text-center p-3">
							<span class="text-info font-italic font-weight-bold" >Kualitas Layanan Akademik dan non Akademik</span>
						</div>
